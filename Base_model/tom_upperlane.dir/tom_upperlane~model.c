...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	switch(index) {
	case 0:
		data = (void*)&this->attribute->am_model.am_AI_CutType;
		break;
	case 1:
		data = (void*)&this->attribute->am_model.am_A_QPtr;
		break;
	case 2:
		data = (void*)&this->attribute->am_model.am_AI_Index;
		break;
	case 3:
		data = (void*)&this->attribute->am_model.am_AI_CutsDone;
		break;
	case 4:
		data = (void*)&this->attribute->am_model.am_AI_ProdType;
		break;
	case 5:
		data = (void*)&this->attribute->am_model.am_AI_index;
		break;
	case 6:
		data = (void*)&this->attribute->am_model.am_AI_PolisherIndex;
		break;
	case 7:
...
set_attdata(load* this)
{
	...
	am_model.am_AI_CutType$att->data = (void*)&this->attribute->am_model.am_AI_CutType;
	am_model.am_A_QPtr$att->data = (void*)&this->attribute->am_model.am_A_QPtr;
	am_model.am_AI_Index$att->data = (void*)&this->attribute->am_model.am_AI_Index;
	am_model.am_AI_CutsDone$att->data = (void*)&this->attribute->am_model.am_AI_CutsDone;
	am_model.am_AI_ProdType$att->data = (void*)&this->attribute->am_model.am_AI_ProdType;
	am_model.am_AI_index$att->data = (void*)&this->attribute->am_model.am_AI_index;
