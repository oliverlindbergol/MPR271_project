...
// Generated:	Mon Nov 26 16:39:14 2018
...
typedef struct loadatt {
	struct {
		int32 am_AI_CutType;	/* AI_CutType */
		queue* am_A_QPtr;	/* A_QPtr */
		int32 am_AI_Index;	/* AI_Index */
		int32 am_AI_CutsDone;	/* AI_CutsDone */
		int32 am_AI_ProdType;	/* AI_ProdType */
		int32 am_AI_index;	/* AI_index */
