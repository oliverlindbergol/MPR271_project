...
begin P_Cutter arriving procedure
	...
	get R_CutOperator
	use R_Cutter(AI_Index) for uniform 55,0.1 sec
	free R_CutOperator
...
begin P_Grinder1 arriving procedure
	...
	if this load type = L_Product40 then	
		use R_Grinder1 for uniform 270,0 sec
	if this load type = L_Product46 then	
		use R_Grinder1 for uniform 290,0 sec
	if this load type = L_Product49 then	
		use R_Grinder1 for uniform 330,0 sec
...
begin P_Grinder2 arriving procedure
	...
	if this load type = L_Product40 then	
		use R_Grinder2 for uniform 270,0 sec
	if this load type = L_Product46 then	
		use R_Grinder2 for uniform 290,0 sec
	if this load type = L_Product49 then	
		use R_Grinder2 for uniform 330,0 sec
