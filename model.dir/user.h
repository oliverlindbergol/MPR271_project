...
typedef struct loadatt {
	struct {
		...
		queue* am_A_QptrCutter;	/* A_QptrCutter */
		int32 am_AI_CutterIndex;	/* AI_CutterIndex */
		int32 am_AI_Cuts;	/* AI_Cuts */
		queue* am_A_QptrLathe;	/* A_QptrLathe */
		int32 am_AI_LatheIndex;	/* AI_LatheIndex */
