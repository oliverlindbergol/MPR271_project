...
initglobs0()
{
	...
	am_model.am_OL_WaitBatchPainting = symGetSystemDataByName(am_model.$sys, "OL_WaitBatchPainting");
	am_model.am_P_Lathes = symGetSystemDataByName(am_model.$sys, "P_Lathes");
	...
	am_model.am_A_QptrCutter$att = symGetSystemDataByName(am_model.$sys, "A_QptrCutter");
	am_model.am_P_Painting = symGetSystemDataByName(am_model.$sys, "P_Painting");
	am_model.am_R_Lathe = symGetSystemDataByName(am_model.$sys, "R_Lathe");
	am_model.am_Q_Lathe = symGetSystemDataByName(am_model.$sys, "Q_Lathe");
	am_model.am_P_Init = symGetSystemDataByName(am_model.$sys, "P_Init");
	am_model.am_P_DownTimePainting = symGetSystemDataByName(am_model.$sys, "P_DownTimePainting");
	...
	am_model.am_P_Unloading = symGetSystemDataByName(am_model.$sys, "P_Unloading");
	am_model.am_Q_BufferLathe = symGetSystemDataByName(am_model.$sys, "Q_BufferLathe");
	am_model.am_Q_PaintingUnloading = symGetSystemDataByName(am_model.$sys, "Q_PaintingUnloading");
	...
	am_model.am_OL_PaintingUnloading = symGetSystemDataByName(am_model.$sys, "OL_PaintingUnloading");
	am_model.am_L_TubeB = symGetSystemDataByName(am_model.$sys, "L_TubeB");
	am_model.am_L_DownCutters = symGetSystemDataByName(am_model.$sys, "L_DownCutters");
	am_model.am_A_QptrLathe$att = symGetSystemDataByName(am_model.$sys, "A_QptrLathe");
	am_model.am_OL_PaintBufferFull = symGetSystemDataByName(am_model.$sys, "OL_PaintBufferFull");
	...
	am_model.am_OL_PaintBatch = symGetSystemDataByName(am_model.$sys, "OL_PaintBatch");
	am_model.am_L_TubeA = symGetSystemDataByName(am_model.$sys, "L_TubeA");
	am_model.am_Q_DummyPainting = symGetSystemDataByName(am_model.$sys, "Q_DummyPainting");
	am_model.am_VI_PrevType$var = symGetSystemDataByName(am_model.$sys, "VI_PrevType");
	am_model.am_VI_PrevType = (int32*)xcalloc(3, sizeof(*am_model.am_VI_PrevType));
	...
	am_model.am_P_Cutting = symGetSystemDataByName(am_model.$sys, "P_Cutting");
	am_model.am_AI_CutterIndex$att = symGetSystemDataByName(am_model.$sys, "AI_CutterIndex");
	am_model.am_AI_Cuts$att = symGetSystemDataByName(am_model.$sys, "AI_Cuts");
	am_model.am_stream0 = symGetSystemDataByName(am_model.$sys, "stream0");
	am_model.am_P_DownTimeLathes = symGetSystemDataByName(am_model.$sys, "P_DownTimeLathes");
	...
	am_model.am_VI_CycleTimeCutter$var = symGetSystemDataByName(am_model.$sys, "VI_CycleTimeCutter");
	am_model.am_VI_CycleTimeCutter = (int32 (*)[4])xcalloc(3, sizeof(*am_model.am_VI_CycleTimeCutter));
	am_model.am_VI_CycleTimeCutter$var->data = (void*)am_model.am_VI_CycleTimeCutter;
	am_model.am_AI_LatheIndex$att = symGetSystemDataByName(am_model.$sys, "AI_LatheIndex");
	am_model.am_Q_BufferPainting = symGetSystemDataByName(am_model.$sys, "Q_BufferPainting");
	am_model.am_P_Creation = symGetSystemDataByName(am_model.$sys, "P_Creation");
	am_model.am_L_Product = symGetSystemDataByName(am_model.$sys, "L_Product");
	am_model.am_stream_R_Lathe_1 = symGetSystemDataByName(am_model.$sys, "stream_R_Lathe_1");
	am_model.am_VI_ArrivingTime$var = symGetSystemDataByName(am_model.$sys, "VI_ArrivingTime");
	am_model.am_VI_ArrivingTime = (int32*)xcalloc(3, sizeof(*am_model.am_VI_ArrivingTime));
	am_model.am_VI_ArrivingTime$var->data = (void*)am_model.am_VI_ArrivingTime;
	am_model.am_VI_SetupCutter$var = symGetSystemDataByName(am_model.$sys, "VI_SetupCutter");
	am_model.am_VI_SetupCutter = (int32 (*)[3])xcalloc(3, sizeof(*am_model.am_VI_SetupCutter));
	am_model.am_VI_SetupCutter$var->data = (void*)am_model.am_VI_SetupCutter;
	am_model.am_P_DownTimeCutters = symGetSystemDataByName(am_model.$sys, "P_DownTimeCutters");
	am_model.am_L_DownLathes = symGetSystemDataByName(am_model.$sys, "L_DownLathes");
	...
	am_model.am_L_DownPainting = symGetSystemDataByName(am_model.$sys, "L_DownPainting");
