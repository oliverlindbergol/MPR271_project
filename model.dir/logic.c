...
// Generated:	Mon Nov 19 18:38:07 2018
...
P_Init_arriving(load* this, int32 step, void* args)
{
	...
	AMDebuggerParams("model.P_Init", P_Init_arriving, localactor, 0, NULL, NULL, NULL);
	{
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Init", P_Init_arriving, localactor, 31);
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Init", P_Init_arriving, localactor, 39);
...
Label1: ;  /* Step1 */
	{
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Creation", P_Creation_arriving, localactor, 44);
			if (LdGetType(this) == am2_L_TubeA) {
				...
				AMDebugger("logic.m", "Arriving procedure", "model.P_Creation", P_Creation_arriving, localactor, 47);
...
Label1: ;  /* Step1 */
	{
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Cutting", P_Cutting_arriving, localactor, 67);
			if (LdGetType(this) == am2_L_TubeA) {
				...
				AMDebugger("logic.m", "Arriving procedure", "model.P_Cutting", P_Cutting_arriving, localactor, 70);
...
Label2: ; // Step 2
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Cutting", P_Cutting_arriving, localactor, 74);
...
Label3: ; // Step 3
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Cutting", P_Cutting_arriving, localactor, 79);
...
Label5: ; // Step 5
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Cutting", P_Cutting_arriving, localactor, 90);
			am2_VI_PrevType[ValidIndex("am_model.am_VI_PrevType", this->attribute->am2_AI_CutterIndex, 2)] = this->attribute->am2_AI_Type;
			EntityChanged(0x01000000);
		}
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Cutting", P_Cutting_arriving, localactor, 93);
...
Label1: ;  /* Step1 */
	{
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Painting", P_Painting_arriving, localactor, 97);
...
Label5: ; // Step 5
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Painting", P_Painting_arriving, localactor, 107);
...
Label6: ; // Step 6
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Painting", P_Painting_arriving, localactor, 110);
			order(am2_VI_BatchSize, am2_OL_PaintBufferFull, NULL, NULL);		// Place an order
		}
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Painting", P_Painting_arriving, localactor, 113);
...
Label8: ; // Step 8
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Painting", P_Painting_arriving, localactor, 118);
...
Label10: ; // Step 10
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Painting", P_Painting_arriving, localactor, 126);
...
Label1: ;  /* Step1 */
	{
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Unloading", P_Unloading_arriving, localactor, 130);
	...
	{
		{
			...
			AMDebugger("logic.m", "Arriving procedure", "model.P_Lathes", P_Lathes_arriving, localactor, 136);
...
Label2: ; // Step 2
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Lathes", P_Lathes_arriving, localactor, 142);
			if (QueGetCurConts(am2_Q_PaintingUnloading) == 0) {
				{
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Lathes", P_Lathes_arriving, localactor, 146);
...
Label4: ; // Step 4
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Lathes", P_Lathes_arriving, localactor, 152);
...
Label5: ; // Step 5
		...
		{
			AMDebugger("logic.m", "Arriving procedure", "model.P_Lathes", P_Lathes_arriving, localactor, 155);
			this->nextproc = am2_die; /* send to ... */
			EntityChanged(W_LOAD);
			retval = Continue;
			goto LabelRet;
