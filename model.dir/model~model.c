...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	case 0:
		...
		break;
	case 1:
		data = (void*)&this->attribute->am_model.am_A_QptrCutter;
		break;
	case 2:
		data = (void*)&this->attribute->am_model.am_AI_CutterIndex;
		break;
	case 3:
		data = (void*)&this->attribute->am_model.am_AI_Cuts;
		break;
	case 4:
		data = (void*)&this->attribute->am_model.am_A_QptrLathe;
		break;
	case 5:
		data = (void*)&this->attribute->am_model.am_AI_LatheIndex;
		break;
	case 6:
		data = (void*)&this->attribute->am_model.am_AI_index;
		break;
	}
	return data;
}
...
set_attdata(load* this)
{
	...
	am_model.am_A_QptrCutter$att->data = (void*)&this->attribute->am_model.am_A_QptrCutter;
	am_model.am_AI_CutterIndex$att->data = (void*)&this->attribute->am_model.am_AI_CutterIndex;
	am_model.am_AI_Cuts$att->data = (void*)&this->attribute->am_model.am_AI_Cuts;
	am_model.am_A_QptrLathe$att->data = (void*)&this->attribute->am_model.am_A_QptrLathe;
	am_model.am_AI_LatheIndex$att->data = (void*)&this->attribute->am_model.am_AI_LatheIndex;
