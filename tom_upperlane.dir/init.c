...
P_Init_arriving(load* this, int32 step, void* args)
{
	...
	{
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_Init", P_Init_arriving, localactor, 18);
		...
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_Init", P_Init_arriving, localactor, 22);
		...
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_Init", P_Init_arriving, localactor, 27);
			am2_VI_BatchSize = 7;
			EntityChanged(0x01000000);
		}
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_Init", P_Init_arriving, localactor, 29);
		...
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_Init", P_Init_arriving, localactor, 53);
...
Label1: ;  /* Step1 */
	{
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_RawMaterialArrival", P_RawMaterialArrival_arriving, localactor, 58);
			while (1 == 1) {
				{
					AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_RawMaterialArrival", P_RawMaterialArrival_arriving, localactor, 59);
...
Label1: ;  /* Step1 */
	{
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_WareHouse", P_WareHouse_arriving, localactor, 65);
...
Label2: ; // Step 2
		...
		{
			AMDebugger("init.m", "Arriving procedure", "tom_upperlane.P_WareHouse", P_WareHouse_arriving, localactor, 66);
