...
// Generated:	Sat Nov 24 12:15:34 2018
...
Label3: ; // Step 3
		}
		{
			...
			return usefor(&(am2_R_Cutter[ValidIndex("am_model.am_R_Cutter", this->attribute->am2_AI_Index, 2)]), 1, this, P_Cutter_arriving, Step 4, am_localargs, ToModelTime(uniform1(am2_stream0, 55, 0.10000000000000001), UNITSECONDS));
Label4: ; // Step 4
		}
		{
...
Label7: ; // Step 7
		...
		}
		{
			...
			return usefor(am2_R_Turner1, 1, this, P_Turner1_arriving, Step 8, am_localargs, ToModelTime(uniform1(am2_stream0, 290, 0), UNITSECONDS));
Label8: ; // Step 8
		}
		{
...
Label6: ; // Step 6
		...
		}
		{
			...
			return usefor(am2_R_Turner1, 1, this, P_Turner2_arriving, Step 7, am_localargs, ToModelTime(uniform1(am2_stream0, 290, 0), UNITSECONDS));
Label7: ; // Step 7
		}
		{
...
Label3: ; // Step 3
		}
		{
			...
			if (LdGetType(this) == am2_L_Product40) {
				...
				return usefor(am2_R_Grinder1, 1, this, P_Grinder1_arriving, Step 4, am_localargs, ToModelTime(uniform1(am2_stream0, 270, 0), UNITSECONDS));
Label4: ; // Step 4
			}
		}
		{
			...
			if (LdGetType(this) == am2_L_Product46) {
				...
				return usefor(am2_R_Grinder1, 1, this, P_Grinder1_arriving, Step 5, am_localargs, ToModelTime(uniform1(am2_stream0, 290, 0), UNITSECONDS));
Label5: ; // Step 5
			}
		}
		{
			...
			if (LdGetType(this) == am2_L_Product49) {
				...
				return usefor(am2_R_Grinder1, 1, this, P_Grinder1_arriving, Step 6, am_localargs, ToModelTime(uniform1(am2_stream0, 330, 0), UNITSECONDS));
Label6: ; // Step 6
			}
		}
		{
...
Label2: ; // Step 2
		}
		{
			...
			if (LdGetType(this) == am2_L_Product40) {
				...
				return usefor(am2_R_Grinder2, 1, this, P_Grinder2_arriving, Step 3, am_localargs, ToModelTime(uniform1(am2_stream0, 270, 0), UNITSECONDS));
Label3: ; // Step 3
			}
		}
		{
			...
			if (LdGetType(this) == am2_L_Product46) {
				...
				return usefor(am2_R_Grinder2, 1, this, P_Grinder2_arriving, Step 4, am_localargs, ToModelTime(uniform1(am2_stream0, 290, 0), UNITSECONDS));
Label4: ; // Step 4
			}
		}
		{
			...
			if (LdGetType(this) == am2_L_Product49) {
				...
				return usefor(am2_R_Grinder2, 1, this, P_Grinder2_arriving, Step 5, am_localargs, ToModelTime(uniform1(am2_stream0, 330, 0), UNITSECONDS));
Label5: ; // Step 5
			}
		}
		{
